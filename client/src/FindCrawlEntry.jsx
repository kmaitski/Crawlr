  ...
  render() {
    return (
      <div
        ...
        onClick={() => {
          this.props.entryClick(this.state);
        }}
      >
        <figure style={{ width: '175px', height: '100%', float: 'left' }}>
          <img
            src={
              ...
              this.props.crawl.bars[0].photo +
              '&sensor=false&maxheight=200&maxwidth=200&key=AIzaSyBP-TMT17pPoumM2HHp1pRUie8DhaalyOw'
            }
          />
          <figcaption>
            <em>{this.props.crawl.bars[0].name}</em>
          </figcaption>
        </figure>
        ...
        <p style={{ verticalAlign: 'bottom', textAlign: 'right' }}>
          {this.props.crawl.description}
        </p>
        <br />
      </div>
    );

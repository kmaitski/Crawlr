...
var crawlData = [
  {
    ...
    Date: 'feb 22',
    bars: [
      { name: 'austinbar1', rating: '4.3' },
      { name: 'austinbar2', rating: '0.2' }
    ],
    rating: 5,
    creator: 'kevinD',
    attendies: ['ryan', 'sam', 'kevinS'],
    directions:
      'https://www.google.com/maps/embed/v1/directions?key=AIzaSyCKqcPwsHVZEmOPMQkCmIGNvNLfV0TVyZc&origin=503+Colorado+St+Austin+TX+78701+USA&waypoints=313+E+6th+St+Austin+TX+78701+USA&destination=61+Rainey+St+Austin+TX+78701+USA&mode=walking'
  }
];
